...
export interface SelfdestructTransferInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "destroyAndTransfer", values: [PromiseOrValue<string>]): string;
    decodeFunctionResult(functionFragment: "destroyAndTransfer", data: BytesLike): Result;
    events: {};
}
export interface SelfdestructTransfer extends BaseContract {
    ...
    functions: {
        destroyAndTransfer(to: PromiseOrValue<string>, overrides?: PayableOverrides & {
    ...
    callStatic: {
        destroyAndTransfer(to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        destroyAndTransfer(to: PromiseOrValue<string>, overrides?: PayableOverrides & {
...
//# sourceMappingURL=SelfdestructTransfer.d.ts.map