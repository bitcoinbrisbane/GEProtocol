...
export interface ZeroReserveInterestRateStrategyInterface extends utils.Interface {
    functions: {
...
export interface ZeroReserveInterestRateStrategy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ZeroReserveInterestRateStrategyInterface;
    ...
    functions: {
        ...
        calculateInterestRates(arg0: DataTypes.CalculateInterestRatesParamsStruct, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, BigNumber]>;
...
//# sourceMappingURL=ZeroReserveInterestRateStrategy.d.ts.map